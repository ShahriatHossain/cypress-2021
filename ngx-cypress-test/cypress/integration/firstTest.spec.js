...
describe("Our first suite", () => {
  ...
  it("assert property", () => {
    ...
    cy.contains("nb-card", "Common Datepicker").then((firstDatepicker) => {
      const formPicker = firstDatepicker.find('[placeholder="Form Picker"]');
      cy.wrap(formPicker).click();

      let dateAssert = selectDayFromCurrent(300);
      cy.wrap(formPicker).invoke("prop", "value").should("contain", dateAssert);
    });
  });
